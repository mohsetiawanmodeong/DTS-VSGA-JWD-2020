				...
				<div class="flexslider">
					<ul class="slides">
						...
						<div class="container">
							...
							<div class="col-sm-6">
								<?php
								$query = mysqli_query($koneksi, "SELECT * FROM pakaian WHERE br_id='$_GET[kd]'");
									...
									<table>
										...
										<tr>
											...
											<td>
												<br>
												<br>
												<a href="pakaian.php" class="btn btn-info">&laquo; KEMBALI</a>
												<br>
												<br>
												<div class="clear">
