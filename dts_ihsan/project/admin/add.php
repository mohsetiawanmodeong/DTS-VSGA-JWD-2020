                                ...
                                <div class="card-body">
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select id="jk" class="custom-select my-1 mr-sm-2" name="jk">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="sekolah" class="form-control" type="text" name="sekolah">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="no_hp" class="form-control" type="text" name="no_hp" required>
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                            <label for="no_ot" class="col-sm-2 col-form-label">Nomor HP Orang Tua</label>
                                            <div class="col-sm-10">
                                                <input id="no_ot" class="form-control" type="text" name="no_ot" required>
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="fb" class="col-sm-2 col-form-label">Nama Facebook</label>
                                            <div class="col-sm-10">
                                                <input id="fb" class="form-control" type="text" name="fb">
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                            <label for="ig" class="col-sm-2 col-form-label">Nama Instagram</label>
                                            <div class="col-sm-10">
                                                <input id="ig" class="form-control" type="text" name="ig">
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                            <label for="rencana" class="col-sm-2 col-form-label">Rencana Kedepan</label>
                                            <div class="col-sm-10">
                                                <select id="rencana" class="custom-select my-1 mr-sm-2" name="rencana">
                                                    <option selected></option>
                                        ...
                                        <button id="buttonSubmit" type="submit" class="btn btn-primary" name="submit">Save</button>
                                    </form>
                                </div>
                            </div>
                        </div>
