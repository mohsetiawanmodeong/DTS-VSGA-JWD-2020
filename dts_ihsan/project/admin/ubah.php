...
$ganti = query("SELECT * FROM bio WHERE id = $id")[0];
                                ...
                                <div class="card-body">
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="nama" class="form-control" type="text" name="nama" required value="<?= $ganti["nama"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="jk" class="col-sm-2 col-form-label">Jenis Kelamin</label>
                                            <div class="col-sm-10">
                                                <select id="jk" class="custom-select my-1 mr-sm-2" name="jk" <?= $ganti["jk"]; ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="sekolah" class="form-control" type="text" name="sekolah" value="<?= $ganti["sekolah"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="jurusan" class="col-sm-2 col-form-label">Jurusan</label>
                                            <div class="col-sm-10">
                                                <input id="jurusan" class="form-control" type="text" name="jurusan" value="<?= $ganti["jurusan"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
                                            <div class="col-sm-10">
                                                <input id="alamat" class="form-control" type="text" name="alamat" value="<?= $ganti["alamat"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email" class="col-sm-2 col-form-label">E-mail</label>
                                            <div class="col-sm-10">
                                                <input id="email" class="form-control" type="text" name="email" value="<?= $ganti["email"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="no_hp" class="col-sm-2 col-form-label">Nomor HP/WA</label>
                                            <div class="col-sm-10">
                                                <input id="no_hp" class="form-control" type="text" name="no_hp" required value="<?= $ganti["no_hp"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="no_ot" class="col-sm-2 col-form-label">Nomor HP Orang Tua</label>
                                            <div class="col-sm-10">
                                                <input id="no_ot" class="form-control" type="text" name="no_ot" required value="<?= $ganti["no_ot"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="fb" class="form-control" type="text" name="fb" value="<?= $ganti["fb"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="ig" class="col-sm-2 col-form-label">Nama Instagram</label>
                                            <div class="col-sm-10">
                                                <input id="ig" class="form-control" type="text" name="ig" value="<?= $ganti["ig"]; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="rencana" class="col-sm-2 col-form-label">Rencana Kedepan</label>
                                            <div class="col-sm-10">
                                                <select id="rencana" class="custom-select my-1 mr-sm-2" name="rencana" value="<?= $ganti["rencana"]; ?>">
                                                    <option selected></option>
